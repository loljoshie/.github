# Contributing to Project Errror

We love your input! We want to make contributing to our organization as easy and transparent as possible, 
whether it's:
...
1. Fork the repo and create your branch from `master` or `develop` (if available).
...
Project Error follows semantic versioning. We release patch versions for critical bugfixes, minor versions for
